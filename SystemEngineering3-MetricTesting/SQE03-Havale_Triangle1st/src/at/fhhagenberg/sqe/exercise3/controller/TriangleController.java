...
import at.fhhagenberg.sqe.exercise3.Triangle1st;
...
public class TriangleController {
				...
				new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						getTriangleView().getSideAValidationMessage().setText(
								Messages.getString("TriangleController.cannotbeblankmessage")); //$NON-NLS-1$
	...
	/**
	 * Triangle Model instance {@link Triangle}
	 * 
	 * @return {@link Triangle}
	 */
	private Triangle getTriangleModel() {
